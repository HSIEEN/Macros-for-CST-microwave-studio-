            	...
            	If  Mid$(CurrentItem,InStr(CurrentItem,"[")+1,InStr(CurrentItem,"]")-InStr(CurrentItem,"[")-1) =  PortNum Then
            		...
            		If InStr(Bands,"L1")<> 0 Then
            			...
            			ReportInformationToWindow( _
       					 EffiType+"@Port_"+PortNum+" Over Band GNSS L1 is: "+Left(Cstr(Avg*100),InStr(Cstr(Avg*100),".")+2)+"% ("+Left(Cstr(dBAvg),InStr(Cstr(dBAvg),".")+2)+ "dB)")
            		End If
            		If InStr(Bands,"L5")<> 0 Then
            			...
            			dBAvg = Log(Avg)/Log(10)*10
            			ReportInformationToWindow( _
       					 EffiType+"@Port_"+PortNum+" Over Band GNSS L5 is: "+Left(Cstr(Avg*100),InStr(Cstr(Avg*100),".")+2)+"% ("+Left(Cstr(dBAvg),InStr(Cstr(dBAvg),".")+2)+ "dB)")
            		End If
            		If InStr(Bands,"W2")<> 0 Then
            			...
            			dBAvg = Log(Avg)/Log(10)*10
            			ReportInformationToWindow( _
       					 EffiType+"@Port_"+PortNum+" Over Band Wifi 2.4GHz is: "+Left(Cstr(Avg*100),InStr(Cstr(Avg*100),".")+2)+"% ("+Left(Cstr(dBAvg),InStr(Cstr(dBAvg),".")+2)+ "dB)")
            		End If
            		If InStr(Bands,"W5")<> 0 Then
            			...
            			dBAvg = Log(Avg)/Log(10)*10
            			ReportInformationToWindow( _
       					 EffiType+"@Port_"+PortNum+" Over Band Wifi 5GHz is: "+Left(Cstr(Avg*100),InStr(Cstr(Avg*100),".")+2)+"% ("+Left(Cstr(dBAvg),InStr(Cstr(dBAvg),".")+2)+ "dB)")
            		End If

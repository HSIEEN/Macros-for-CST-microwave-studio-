...
Sub Main ()
	...
	Begin Dialog UserDialog 810,434,"Single parameter sweep for RHCP directivity comparison" ' %GRID:10,7,1,1
		...
		OptionGroup .Group1
			OptionButton 660,210,40,14,"¦È",.OptionButton1
			OptionButton 660,238,40,14,"¦Õ",.OptionButton2
...
Sub writeAverageDirectivityAndRating(sheet As Object, Columns As String)
	...
	sheet.Range("P3").Value = "30¡ã"
	sheet.Range("P4").Value = "45¡ã"
	sheet.Range("P5").Value = "60¡ã"
	sheet.Range("P6").Value = "90¡ã"
	sheet.Range("P7").Value = "120¡ã"
